...
@basset(base_path('node_modules/@popperjs/core/dist/umd/popper.min.js'))
@basset(base_path('node_modules/noty/lib/noty.min.js'))
@basset(base_path('node_modules/sweetalert/dist/sweetalert.min.js'))
