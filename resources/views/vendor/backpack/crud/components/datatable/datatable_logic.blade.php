...
{{-- DATA TABLES SCRIPT --}}
@basset(base_path('node_modules/datatables.net/js/dataTables.min.js'))
@basset(base_path('node_modules/datatables.net-bs5/js/dataTables.bootstrap5.min.js'))
@basset(base_path('node_modules/datatables.net-responsive/js/dataTables.responsive.min.js'))
@basset(base_path('node_modules/datatables.net-fixedheader/js/dataTables.fixedHeader.min.js'))
@basset(base_path('vendor/backpack/crud/src/resources/assets/img/spinner.svg'), false)

@push('before_styles')
    @basset(base_path('node_modules/datatables.net-bs5/css/dataTables.bootstrap5.min.css'))
    @basset(base_path('node_modules/datatables.net-responsive-bs5/css/responsive.bootstrap5.min.css'))
    @basset(base_path('node_modules/datatables.net-fixedheader-bs5/css/fixedHeader.bootstrap5.min.css'))
@endpush
